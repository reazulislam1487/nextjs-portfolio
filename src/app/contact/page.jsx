          ...
          >
            <div
              className="bg-gradient-to-br from-gray-900/60 via-gray-800/80 to-black/90 
                           ...
                           hover:border-gray-500/50 relative overflow-hidden group"
            >
              {/* Background glow */}
              <div
              ...
              <div className="relative z-10">
                ...
                <div className="space-y-6 text-base">
                  ...
                  <motion.div
                    ...
                    className="flex items-center gap-4 p-4 bg-gray-800/30 rounded-2xl border border-gray-700/30
                              hover:border-purple-500/40 transition-all duration-300 group/item cursor-pointer"
                  >
                    <div
                      className="p-3 bg-purple-500/10 rounded-xl border border-purple-500/20
                                   group-hover/item:bg-purple-500/20 transition-colors duration-300"
                    >
                  ...
                  <motion.div
                    whileHover={{ x: 5, scale: 1.02 }}
                    className="flex items-center gap-4 p-4 bg-gray-800/30 rounded-2xl border border-gray-700/30
                              hover:border-green-500/40 transition-all duration-300 group/item cursor-pointer"
                  >
                    <div
                      className="p-3 bg-green-500/10 rounded-xl border border-green-500/20
                                   group-hover/item:bg-green-500/20 transition-colors duration-300"
                    >
                  ...
                  <motion.div
                    whileHover={{ x: 5, scale: 1.02 }}
                    className="flex items-center gap-4 p-4 bg-gray-800/30 rounded-2xl border border-gray-700/30
                              hover:border-cyan-500/40 transition-all duration-300 group/item cursor-pointer"
                  >
                    <div
                      className="p-3 bg-cyan-500/10 rounded-xl border border-cyan-500/20
                                   group-hover/item:bg-cyan-500/20 transition-colors duration-300"
                    >
                    ...
                    <div className="flex items-center gap-4">
                      <motion.a
                        ...
                        className="p-3 bg-gray-700/30 rounded-xl border border-gray-600/30 
                                 hover:border-gray-400/50 hover:bg-gray-600/40 transition-all duration-300
                                 text-gray-400 hover:text-white shadow-lg hover:shadow-xl"
                      >
                      ...
                      <motion.a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="p-3 bg-blue-600/20 rounded-xl border border-blue-500/30 
                                 hover:border-blue-400/50 hover:bg-blue-500/30 transition-all duration-300
                                 text-blue-400 hover:text-blue-300 shadow-lg hover:shadow-xl"
                      >
            ...
            <div className="relative z-10">
              ...
              <form ref={form} onSubmit={sendEmail} className="space-y-6">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 bg-gray-800/50 border border-gray-600/50 rounded-xl 
                             ...
                             hover:border-gray-500/70 backdrop-blur-sm"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-3 bg-gray-800/50 border border-gray-600/50 rounded-xl 
                             text-white placeholder-gray-400 focus:outline-none focus:ring-2 
                             focus:ring-purple-500/50 focus:border-purple-500/50 transition-all duration-300
                             hover:border-gray-500/70 backdrop-blur-sm resize-none"
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  type="submit"
                  className="w-full px-8 py-4 bg-gradient-to-r from-purple-600 via-purple-700 to-cyan-600 
                ...
                >
                  ...
                  <div
                    className="absolute inset-0 opacity-0 group-hover/btn:opacity-100 transition-opacity duration-500
                                 ...
                                 transform -skew-x-12 translate-x-[-100%] group-hover/btn:translate-x-[200%] 
                                 "
                  ></div>
